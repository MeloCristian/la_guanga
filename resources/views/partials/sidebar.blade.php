...
<div class="l-navbar" id="nav-bar">
    <nav class="nav">
        <div> <a href="/" class="nav_link"> <i class="fa-solid fa-house"></i> <span
                    class="nav_logo-name">Home</span> </a>
            <div class="nav_list">
                <li class="mb-1">
                    <a class="nav_link active" data-bs-toggle="collapse" href="#catalog-collapse" aria-expanded="true">
        ...
        @if (Auth::check())
            <form action="{{ url('logout') }}" method="POST" id="logout">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                <a onclick="document.getElementById('logout').submit();" class="nav_link">
